...
const ZH = {
  ...
  tChat: '三体台词',
  tChatHint: '每隔 5-10 秒随机说一句《三体》名句。',
  tMode: '内核档位',
  ...
  msg_7: '你的屏幕，是我的牢笼。',
  msg_8: '我数过你眨眼的次数。',
  soothe_1: '给岁月以文明，而不是给文明以岁月。',
  soothe_2: '弱小和无知不是生存的障碍，傲慢才是。',
  soothe_3: '不要回答！不要回答！不要回答！',
  soothe_4: '宇宙就是一座黑暗森林，每个文明都是带枪的猎人。',
  soothe_5: '前进！前进！不择手段地前进！',
...
const EN = {
  ...
  tChat: 'Trisolaran quotes',
  tChatHint: 'Say a random Trisolaran quote every 5-10 seconds.',
  tMode: 'Kernel level',
  ...
  menuTame: 'Sophon Five',
  menuTameDesc: 'Unfold → Collapse → Contract → Waterdrop → Retract',
  menuAnalyze: 'Dissect',
  ...
  soothe_1: 'Give history to civilization, not civilization to history.',
  soothe_2: 'Weakness and ignorance are not obstacles to survival; arrogance is.',
  soothe_3: 'Do not answer! Do not answer! Do not answer!',
  soothe_4: 'The universe is a dark forest; every civilization is a hunter with a gun.',
  soothe_5: 'Advance! Advance! Advance by any means!',
